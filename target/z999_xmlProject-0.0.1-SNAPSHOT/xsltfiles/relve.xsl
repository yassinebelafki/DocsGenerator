                                ...
                                <fo:table-cell>
                                    <fo:block>
                                        <fo:external-graphic
                                                ...
                                                content-width="6cm"
                                                content-height="6cm"
                                                src="url(C:/Users/YASSINE/Desktop/JAVA/JAKARTA/z999_xmlProject/src/main/webapp/images/im1.png)">
                                        </fo:external-graphic>
                                    </fo:block>
                                </fo:table-cell>
                                <fo:table-cell >
                                ...
                                <fo:table-cell>
                                    <fo:block text-align="center">
                                        <fo:external-graphic
                                                ...
                                                content-width="6cm"
                                                content-height="6cm"
                                                src="url(C:\Users\YASSINE\Desktop\JAVA\JAKARTA\z999_xmlProject\src\main\webapp\images\im2.png)">
